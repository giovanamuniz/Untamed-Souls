extends CanvasLayer # (Ou o tipo de nó raiz do seu HUD)

@onready var heart1 = $Heart1
@onready var heart2 = $Heart2
@onready var heart3 = $Heart3

# IMPORTANTE: Só precisamos da textura do coração CHEIO
# Coloque o caminho correto para sua imagem de coração cheio:
var full_heart_texture = preload("res://assets/images/coracao.png")
# Não precisamos mais do coração vazio!
